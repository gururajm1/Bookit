...
const Payment = () => {
  ...
  const handlePaymentSuccess = async (paymentResponse: any) => {
    try {
      ...
      // Update cinema seats
      const updateResponse = await fetch('http://localhost:1001/bookit/cinema/seats', {
        method: 'POST',
        headers: {
      ...
      const userUpdateResponse = await fetch('http://localhost:1001/bookit/user/add-booking', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
